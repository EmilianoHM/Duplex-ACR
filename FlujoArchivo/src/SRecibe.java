...
for (;;) {
    ...
    if (solicitud.equals("SOLICITUD_ARCHIVO")) {
        ...
        //llamada a funcion para renombrar----------------------
    } else {
 ...
 private static void recibirDirectorio(DataInputStream dis, String Ruta_Archivo) throws IOException {
    ...
    private static void recibirArchivoIndividual(DataInputStream dis, String directorioDestino) throws IOException {
...
private static void listarDirectorioServidor(DataOutputStream dos, String rutaServidor) throws IOException {
   ...
   private static void listarDirectorioRecursivo(File directorio, DataOutputStream dos, String prefijo) throws IOException {
    ...
    public static void eliminarElemento(DataOutputStream dos, DataInputStream dis, String rutaServidor) throws IOException {
